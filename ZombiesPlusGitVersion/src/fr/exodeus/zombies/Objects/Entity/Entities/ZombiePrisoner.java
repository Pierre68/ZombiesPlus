...
import fr.exodeus.zombies.Objects.Entity.Render.ZombiePrisonerRender;
...
public class ZombiePrisoner extends EntityMob {

	public ZombiePrisoner(World par1World) {
		super(par1World);
	...
	public static void registerRender(){
		RenderingRegistry.registerEntityRenderingHandler(ZombiePrisoner.class, new ZombiePrisonerRender());
	}
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		case 0:
			this.dropItem(RustyChain.rusty_chain, r.nextInt(3) - 1);
